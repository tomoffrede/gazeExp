...
summary(f2 <- lmer(f0sd ~ robf0sdc : condition : turn + (1 + condition | speaker), dat))
...
summary(f1 <- lmer(f0mean ~ intimc + intensMeanC  + (1 | speaker), dat))
...
summary(f1 <- lmer(f0sd ~ intimc + intensMeanC + (1 | speaker), dat))
