...
```{r}
dac$condition <- relevel(dac$condition, ref="NG")
summary(f0 <- lmer(f0mean ~ robf0meanc : condition + (1 + condition | speaker), dac))
...
```{r}
summary(intel1 <- lmer(f0mean ~ robf0meanc : IOc : condition + (1 + condition | speaker), dac))
...
```{r}
summary(cf1 <- lmer(f0mean ~ robf0meanc : ConvQualc : condition + (1 + condition | speaker), dac))
...
```{r}
summary(hl1 <- lmer(f0mean ~ robf0meanc : EvalRobotc : condition + (1 + condition | speaker), dac))
